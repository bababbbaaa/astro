...
managers=[952863788,214207257, 778327202,5312336082,1098353716,720247439,5127634821]
...
cost_text='''
С 22 февраля 2023 года действуют специальные условия по подписке на Астробот
Доступно 3 варианта продления подписки: на 30, 180 и 365 дней.

✅ Стоимость подписки на месяц - <strike>99</strike> 79 рублей

На полугодовой и годовой тариф действует скидка 35 и 45 % соответственно:
...
Вы можете прямо сейчас активировать платную подписку на СПЕЦИАЛЬНЫХ ПЕРСОНАЛЬНЫХ УСЛОВИЯХ!

Время оставшегося пробного периода суммируется с временем подписки.'''
